'use client'
import LocalTime from '@/src/app/components/LocalTime'
...
export default function Fixtures({ fixturesByTeamId, teamId }: PageProps) {
	...
	return (
		<div className="flex flex-col w-full justify-center items-center text-neutral-100">
					...
					>
						{firstItemsFixturesFuture.map((fixture, i) => (
							<Link
								...
								className="w-full flex-shrink-0 flex text-neutral-100 items-center h-36 bg-gradient-to-r from-black/90 to-black/40 hover:bg-sky-800"
							>
								<div className="flex flex-col justify-center items-center w-3/12 text-sm md:text-base text-center">
									<Image
								...
								<div className="flex flex-col justify-center items-center w-1/2">
									<div className="h-1/6 text-center text-[8px] text-sm md:text-base">
										{fixture.league.name}
									</div>
									<div className="h-1/6 text-center text-[8px] text-sm md:text-base">
									...
									<div className="flex w-full justify-between items-center h-2/6 md:text-2xl">
										<div className="flex flex-col justify-center items-center">
											{fixture.score.penalty.home !== null ? (
												<div className="flex flex-col justify-center items-center text-sm md:text-base text-[8px]">
									...
									<div className="h-1/6 text-center text-[8px] text-sm md:text-base"></div>
								</div>
								<div className="flex flex-col justify-center items-center w-3/12 text-sm md:text-base text-center">
									<Image
			...
			<div className="flex flex-col w-full justify-center items-center">
				<div className="flex w-full justify-center items-center p-2 bg-gradient-to-r from-sky-800/80 to-sky-800/30">
					Match Results
				</div>
				{firstItemsFixturesDone.map((fixture, i) => (
					<div
						key={i}
						className="flex w-full text-neutral-100 items-center h-36 bg-gradient-to-r from-black/90 to-black/40 hover:bg-sky-800"
					>
						<Link
							href={`/match/${fixture.fixture.id}`}
							key={fixture.fixture.id}
							className="w-full flex text-neutral-100 items-center h-36 bg-gradient-to-r from-black/90 to-black/40 hover:bg-sky-800"
						>
							<div className="flex flex-col justify-center items-center w-3/12 text-sm md:text-base text-center">
								<Image
									src={fixture.teams.home.logo}
							...
							<div className="flex flex-col justify-center items-center w-1/2">
								<div className="h-1/6 text-center text-[8px] text-xs md:text-base">
									{fixture.league.name}
								</div>
								<div className="h-1/6 text-center text-[8px] text-xs md:text-base">
									<LocalTime fixture={fixture} />
								...
								<div className="flex w-full justify-between items-center h-2/6 md:text-2xl">
									...
									<div className="flex flex-col justify-center items-center">
										...
										{fixture.score.penalty.away !== null ? (
											<div className="flex flex-col justify-center items-center text-xs md:text-xs text-[8px]">
												<div>(et. ){fixture.score.extratime.away}</div>
												<div>(pen.){fixture.score.penalty.away}</div>
											</div>
										) : fixture.score.extratime.away !== null ? (
								...
								<div className="h-1/6 text-center text-xs text-[8px] md:text-base">
									{fixture.fixture.venue.name}
								</div>
								<div className="h-1/6 text-center text-xs text-[8px] md:text-base"></div>
							</div>
							<div className="flex flex-col justify-center items-center w-3/12 text-sm md:text-base text-center">
								<Image
									src={fixture.teams.away.logo}
